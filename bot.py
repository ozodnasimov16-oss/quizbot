...
def send_poll_question(chat_id, user_id):
    ...
    # Quiz faol emasligini tekshirish
    if not user_data[user_id].get('quiz_active', False):
        return
    ...
    msg = bot.send_poll(
        ...
        explanation=f"📊 Savol {current + 1}/{len(questions)} | /stop - To'xtatish"
    )
